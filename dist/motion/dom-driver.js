...
export const domMotionDriver = {
    name: "dom",
    render(spec, target, runtime) {
        if (runtime.reducedMotion)
            return; // accessibility: motion off → no-op
        switch (spec.kind) {
            case "none":
                return;
            case "custom":
...
//# sourceMappingURL=dom-driver.js.map